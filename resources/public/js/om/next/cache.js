...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__23189 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__23191 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__23191,x_SINGLEQUOTE__23189,this$){
return (function (p1__23188_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__23188_SHARP_,id_SINGLEQUOTE__23191),id,x_SINGLEQUOTE__23189);
});})(id_SINGLEQUOTE__23191,x_SINGLEQUOTE__23189,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__23189);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__22626__auto__,writer__22627__auto__,opt__22628__auto__){
return cljs.core._write.call(null,writer__22627__auto__,"om.next.cache/Cache");
});
