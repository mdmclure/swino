...
return (function (){
var x__22857__auto__ = cljs.core.symbol.call(null,schema.utils.fn_name.call(null,g));
return cljs.core._conj.call(null,(function (){var x__22857__auto____$1 = schema.utils.value_name.call(null,x);
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__22642__auto__,k__22643__auto__){
var self__ = this;
var this__22642__auto____$1 = this;
return cljs.core._lookup.call(null,this__22642__auto____$1,k__22643__auto__,null);
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__22644__auto__,k26178,else__22645__auto__){
var self__ = this;
var this__22644__auto____$1 = this;
var G__26182 = (((k26178 instanceof cljs.core.Keyword))?k26178.fqn:null);
switch (G__26182) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k26178,else__22645__auto__);
...
var or__22020__auto____$1 = self__.post.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x));
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__22656__auto__,writer__22657__auto__,opts__22658__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__22646__auto__){
var self__ = this;
var this__22646__auto____$1 = this;
return (4 + cljs.core.count.call(null,self__.__extmap));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__22637__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__22638__auto__,other__22639__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__22651__auto__,k__22652__auto__){
var self__ = this;
var this__22651__auto____$1 = this;
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"err-f","err-f",651620941),null,new cljs.core.Keyword(null,"post","post",269697687),null,new cljs.core.Keyword(null,"options","options",99638489),null], null), null),k__22652__auto__)){
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__22652__auto__)),null));
}
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__22649__auto__,k__22650__auto__,G__26177){
var self__ = this;
var this__22649__auto____$1 = this;
var pred__26214 = cljs.core.keyword_identical_QMARK_;
var expr__26215 = k__22650__auto__;
if(cljs.core.truth_(pred__26214.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__26215))){
return (new schema.spec.variant.VariantSpec(G__26177,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__26214.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__26215))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__26177,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__26214.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__26215))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__26177,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__26214.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__26215))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__26177,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__22650__auto__,G__26177),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__22654__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__22641__auto__,G__26177){
var self__ = this;
var this__22641__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__26177,self__.__extmap,self__.__hash));
});

schema.spec.variant.VariantSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__22647__auto__,entry__22648__auto__){
var self__ = this;
...
schema.spec.variant.VariantSpec.cljs$lang$ctorPrSeq = (function (this__22676__auto__){
return cljs.core._conj.call(null,cljs.core.List.EMPTY,"schema.spec.variant/VariantSpec");
});

schema.spec.variant.VariantSpec.cljs$lang$ctorPrWriter = (function (this__22676__auto__,writer__22677__auto__){
return cljs.core._write.call(null,writer__22677__auto__,"schema.spec.variant/VariantSpec");
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__26180){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__26180),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__26180),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__26180),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__26180),null,cljs.core.dissoc.call(null,G__26180,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)),null));
});
...
var args26358 = [];
var len__23128__auto___26365 = arguments.length;
var i__23129__auto___26366 = (0);
while(true){
if((i__23129__auto___26366 < len__23128__auto___26365)){
args26358.push((arguments[i__23129__auto___26366]));

var G__26367 = (i__23129__auto___26366 + (1));
i__23129__auto___26366 = G__26367;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__22020__auto__ = err_f;
if(cljs.core.truth_(or__22020__auto__)){
return or__22020__auto__;
} else {
